<div id="stockList" class="tab-content">
                    <div class="search-filter-bar no-print" style="flex-wrap: nowrap; overflow-x: auto; gap: 0.5rem; align-items: flex-end; margin-bottom: 0.5rem; padding-bottom: 0.2rem;">
                        <div class="form-group" style="flex: 1; min-width: 80px; margin-bottom: 0;">
                            ...
                            <input type="text" id="stockSearch" class="form-control" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" placeholder="Search..." oninput="refreshStockList()">
                        </div>
                        <div class="form-group" style="flex: 1; min-width: 80px; margin-bottom: 0;">
                            <label style="font-size: 0.85rem; margin-bottom: 2px;">Group Filter</label>
                            <select id="stockGroupFilter" class="form-control" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onchange="refreshStockList()">
                        ...
                        <div class="form-group" style="flex: 1; min-width: 80px; margin-bottom: 0;">
                            ...
                            <select id="stockLengthFilter" class="form-control" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onchange="refreshStockList()">
                                <option value="">All Lengths</option>
                            </select>
                        </div>
                        <div class="form-group" style="flex: 1; min-width: 80px; margin-bottom: 0;">
                            <label style="font-size: 0.85rem; margin-bottom: 2px;">Order Status</label>
                            <select id="stockOrderFilter" class="form-control" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onchange="refreshStockList()">
                        ...
                        <div class="form-group" style="flex: 1; min-width: 80px; margin-bottom: 0;">
                            ...
                            <select id="stockZeroFilter" class="form-control" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onchange="refreshStockList()">
                        ...
                        <div class="form-group" style="flex: 1; min-width: 80px; margin-bottom: 0;">
                            ...
                            <input type="date" id="stockDateFrom" class="form-control" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onchange="refreshStockList()">
                        </div>
                        <div class="form-group" style="flex: 1; min-width: 80px; margin-bottom: 0;">
                            <label style="font-size: 0.85rem; margin-bottom: 2px;">To Date</label>
                            <input type="date" id="stockDateTo" class="form-control" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onchange="refreshStockList()">
                        </div>
                        <div class="btn-group" style="margin-left: auto; flex: 0 1 auto; justify-content: flex-end;">
                            <button class="btn btn-print" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onclick="printStockList()">🖨️ Print</button>
                            <button class="btn btn-secondary" style="padding: 0.2rem 0.5rem; font-size: 0.85rem; height: 32px;" onclick="clearStockFilters()">🧹 Clear</button>
                        </div>
                    </div>
