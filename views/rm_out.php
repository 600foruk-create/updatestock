<div class="rm-transactions">
    ...
    <div class="form-card" style="margin-bottom: 2rem; background: transparent; box-shadow: none; border: none; padding: 0;">
        ...
        <div class="form-group" style="max-width: 200px; margin-bottom: 1.5rem;">
            ...
            <input type="date" id="rmOutDate" class="form-control" style="height: 40px; border-radius: 8px; border: 2px solid #cbd5e1; width: 100%; background: white;">
        </div>

        <!-- Single Item Mode Container -->
        <div id="rmOutSingleGroup">
            <div id="rmOutRows" style="display: flex; flex-direction: column; gap: 0.8rem; background: #f8fafc; padding: 1.5rem; border-radius: 12px; border: 1px solid #e2e8f0; margin-bottom: 1rem;">
                <!-- Rows will be added here via JS -->
            </div>
            <button class="btn btn-info" onclick="addRMRow('OUT')" style="padding: 0.6rem 1.5rem; font-weight: 700; border-radius: 8px; display: flex; align-items: center; gap: 8px; margin-bottom: 1rem;">➕ Add Item</button>
        </div>
        
        <!-- Formula Mode (stays same but hidden/shown via JS) -->
        <div id="rmOutFormulaGroup" style="display: none; background: #f0f9ff; padding: 1.5rem; border-radius: 12px; border: 1.5px solid var(--sky-200); margin-bottom: 1rem;">
            ...
            <div class="form-group" style="margin-bottom: 0; position: relative;">
                <label style="font-weight: 700; color: var(--gray-700); margin-bottom: 0.5rem; font-size: 0.9rem; display: block;">Multiplier (Number of Batches)</label>
                <input type="number" id="rmOutFormulaMultiplier" class="form-control" style="height: 48px; border: 2px solid var(--sky-500); border-radius: 8px; padding: 0.6rem 1rem;" value="1" oninput="previewFormulaUsage()">
            </div>
        </div>
