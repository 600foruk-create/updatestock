<div class="rm-dashboard">
    ...
    <div class="dashboard-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
        <div class="stat-card" style="background: white; padding: 1rem; border-radius: 6px; border: 1px solid #000;">
            ...
            <div class="stat-value" id="rmTotalItems" style="font-size: 2rem; font-weight: 800; color: #000; margin-top: 0.3rem;">0</div>
        </div>
        <div class="stat-card" style="background: white; padding: 1rem; border-radius: 6px; border: 1px solid #000;">
            ...
            <div class="stat-value" id="rmTotalWeightKg" style="font-size: 2rem; font-weight: 800; color: #000; margin-top: 0.3rem;">0</div>
        </div>
        <div class="stat-card" style="background: white; padding: 1rem; border-radius: 6px; border: 1px solid #000;">
            ...
            <div class="stat-value" id="rmLowStockCount" style="font-size: 2rem; font-weight: 800; color: var(--error); margin-top: 0.3rem;">0</div>
        </div>
    </div>
