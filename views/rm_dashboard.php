<div class="rm-dashboard">
    ...
    <div class="dashboard-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
        <div class="stat-card" style="background: #dbeafe; padding: 1rem; border-radius: 6px; border: 1px solid #000;">
        ...
        <div class="stat-card" style="background: #dcfce7; padding: 1rem; border-radius: 6px; border: 1px solid #000;">
        ...
        <div class="stat-card" style="background: #fee2e2; padding: 1rem; border-radius: 6px; border: 1px solid #000;">
